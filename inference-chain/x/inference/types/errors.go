...
var (
	...
	ErrEmptyMessage                          = sdkerrors.Register(ModuleName, 1166, "message is empty")
	ErrEmptyVotingResult                     = sdkerrors.Register(ModuleName, 1167, "voting result is empty")
	ErrCreatorMismatch                       = sdkerrors.Register(ModuleName, 1168, "message creators are different")
	ErrInferenceIdMismatch                   = sdkerrors.Register(ModuleName, 1169, "inference IDs are different")
	ErrInferenceFinishedWithMissingPayload   = sdkerrors.Register(ModuleName, 1170, "inference has finished with missing payload")
)
