...
type MsgFinishInferenceWithMissingPayload struct {
	Creator            string              `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
	MsgFinishInference *MsgFinishInference `protobuf:"bytes,2,opt,name=msg_finish_inference,json=msgFinishInference,proto3" json:"msg_finish_inference,omitempty"`
	VotingResult       *VotingResult       `protobuf:"bytes,3,opt,name=voting_result,json=votingResult,proto3" json:"voting_result,omitempty"`
}

func (m *MsgFinishInferenceWithMissingPayload) Reset()         { *m = MsgFinishInferenceWithMissingPayload{} }
func (m *MsgFinishInferenceWithMissingPayload) String() string { return proto.CompactTextString(m) }
func (*MsgFinishInferenceWithMissingPayload) ProtoMessage()    {}
func (*MsgFinishInferenceWithMissingPayload) Descriptor() ([]byte, []int) {
	return fileDescriptor_09b36d0241b9acd5, []int{5}
}
func (m *MsgFinishInferenceWithMissingPayload) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgFinishInferenceWithMissingPayload) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgFinishInferenceWithMissingPayload.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgFinishInferenceWithMissingPayload) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgFinishInferenceWithMissingPayload.Merge(m, src)
}
func (m *MsgFinishInferenceWithMissingPayload) XXX_Size() int {
	return m.Size()
}
func (m *MsgFinishInferenceWithMissingPayload) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgFinishInferenceWithMissingPayload.DiscardUnknown(m)
}

var xxx_messageInfo_MsgFinishInferenceWithMissingPayload proto.InternalMessageInfo

func (m *MsgFinishInferenceWithMissingPayload) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func (m *MsgFinishInferenceWithMissingPayload) GetMsgFinishInference() *MsgFinishInference {
	if m != nil {
		return m.MsgFinishInference
	}
	return nil
}

func (m *MsgFinishInferenceWithMissingPayload) GetVotingResult() *VotingResult {
	if m != nil {
		return m.VotingResult
	}
	return nil
}
...
type MsgFinishInferenceWithMissingPayloadResponse struct {
	InferenceIndex string `protobuf:"bytes,1,opt,name=inference_index,json=inferenceIndex,proto3" json:"inference_index,omitempty"`
	ErrorMessage   string `protobuf:"bytes,2,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"`
}

func (m *MsgFinishInferenceWithMissingPayloadResponse) Reset() {
	*m = MsgFinishInferenceWithMissingPayloadResponse{}
}
func (m *MsgFinishInferenceWithMissingPayloadResponse) String() string {
	return proto.CompactTextString(m)
}
func (*MsgFinishInferenceWithMissingPayloadResponse) ProtoMessage() {}
func (*MsgFinishInferenceWithMissingPayloadResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_09b36d0241b9acd5, []int{7}
}
func (m *MsgFinishInferenceWithMissingPayloadResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgFinishInferenceWithMissingPayloadResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgFinishInferenceWithMissingPayloadResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgFinishInferenceWithMissingPayloadResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgFinishInferenceWithMissingPayloadResponse.Merge(m, src)
}
func (m *MsgFinishInferenceWithMissingPayloadResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgFinishInferenceWithMissingPayloadResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgFinishInferenceWithMissingPayloadResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgFinishInferenceWithMissingPayloadResponse proto.InternalMessageInfo

func (m *MsgFinishInferenceWithMissingPayloadResponse) GetInferenceIndex() string {
	if m != nil {
		return m.InferenceIndex
	}
	return ""
...
func (m *MsgFinishInferenceWithMissingPayloadResponse) GetErrorMessage() string {
	if m != nil {
		return m.ErrorMessage
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*MsgFinishInferenceWithMissingPayload)(nil), "inference.inference.MsgFinishInferenceWithMissingPayload")
	proto.RegisterType((*MsgFinishInferenceResponse)(nil), "inference.inference.MsgFinishInferenceResponse")
	proto.RegisterType((*MsgFinishInferenceWithMissingPayloadResponse)(nil), "inference.inference.MsgFinishInferenceWithMissingPayloadResponse")
...
var fileDescriptor_09b36d0241b9acd5 = []byte{
	...
	,
}
...
func (c *msgClient) FinishInferenceWithMissingPayload(ctx context.Context, in *MsgFinishInferenceWithMissingPayload, opts ...grpc.CallOption) (*MsgFinishInferenceWithMissingPayloadResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inference.inference.Msg/FinishInferenceWithMissingPayload", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMsgServer) FinishInferenceWithMissingPayload(ctx context.Context, req *MsgFinishInferenceWithMissingPayload) (*MsgFinishInferenceWithMissingPayloadResponse, error) {
...
func _Msg_FinishInferenceWithMissingPayload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inference.inference.Msg/FinishInferenceWithMissingPayload",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *MsgFinishInferenceWithMissingPayload) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgFinishInferenceWithMissingPayload) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgFinishInferenceWithMissingPayload) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.VotingResult != nil {
		{
			size, err := m.VotingResult.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.MsgFinishInference != nil {
		{
			size, err := m.MsgFinishInference.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MsgFinishInferenceWithMissingPayloadResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgFinishInferenceWithMissingPayloadResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgFinishInferenceWithMissingPayloadResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgSubmitPocValidation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ReceivedDist) > 0 {
		for iNdEx := len(m.ReceivedDist) - 1; iNdEx >= 0; iNdEx-- {
			f8 := math.Float64bits(float64(m.ReceivedDist[iNdEx]))
			i -= 8
	...
	if len(m.Dist) > 0 {
		for iNdEx := len(m.Dist) - 1; iNdEx >= 0; iNdEx-- {
			f9 := math.Float64bits(float64(m.Dist[iNdEx]))
			i -= 8
	...
	if len(m.Nonces) > 0 {
		dAtA11 := make([]byte, len(m.Nonces)*10)
		var j10 int
		for _, num1 := range m.Nonces {
			num := uint64(num1)
			for num >= 1<<7 {
...
func (m *MsgFinishInferenceWithMissingPayload) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.MsgFinishInference != nil {
		l = m.MsgFinishInference.Size()
		n += 1 + l + sovTx(uint64(l))
	}
	if m.VotingResult != nil {
		l = m.VotingResult.Size()
		n += 1 + l + sovTx(uint64(l))
	}
	return n
}
...
func (m *MsgFinishInferenceWithMissingPayloadResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgFinishInferenceWithMissingPayload) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgFinishInferenceWithMissingPayload: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgFinishInferenceWithMissingPayload: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MsgFinishInference", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MsgFinishInference == nil {
				m.MsgFinishInference = &MsgFinishInference{}
			}
			if err := m.MsgFinishInference.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VotingResult", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.VotingResult == nil {
				m.VotingResult = &VotingResult{}
			}
			if err := m.VotingResult.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *MsgFinishInferenceWithMissingPayloadResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgFinishInferenceWithMissingPayloadResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgFinishInferenceWithMissingPayloadResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
